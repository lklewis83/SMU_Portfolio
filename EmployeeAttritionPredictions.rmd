...
Monthly Income Predict Missing Values
```{r}
# Obtain the Mean MonthlyIncome and save to a dataset
mean_income <- aggregate(MonthlyIncome ~ Attrition + JobRole + Age, data = attrition, FUN = mean)
...
Attrition Prediction for Missing values
```{r}
